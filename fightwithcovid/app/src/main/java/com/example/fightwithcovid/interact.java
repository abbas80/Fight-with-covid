...
public class interact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(interact.this,"user id="+userid,Toast.LENGTH_SHORT).show();
        FirebaseDatabase.getInstance().getReference().child("User").child(userid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(interact.this,"user id="+user.getInteracted_user(),Toast.LENGTH_SHORT).show();

                interactee_list=user.getInteracted_user();

                Toast.makeText(interact.this,"user id="+interactee_list,Toast.LENGTH_SHORT).show();
