...
///    private boolean isPermission;
    ...
    List<com.example.covid.coordinates> distance_coordinatesList1=new ArrayList<>();
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                List<com.example.covid.coordinates> coordinatesList=new ArrayList<>();
                ...
                com.example.covid.coordinates u1=new com.example.covid.coordinates(latLng.latitude,latLng.longitude,Long.parseLong(userid));
...
*/
                ...
                FirebaseDatabase.getInstance().getReference().child("Coordinates").child(userid)
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(com.example.covid.track.this,"Location saved",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            Toast.makeText(com.example.covid.track.this,"Location not saved",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                FirebaseDatabase.getInstance().getReference().child("Coordinates").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    {
                       com.example.covid.coordinates c=new com.example.covid.coordinates();

                       c=d.getValue(com.example.covid.coordinates.class);
                ...
                Toast.makeText(com.example.covid.track.this,"dist b/w "+distance_coordinatesList1,Toast.LENGTH_SHORT).show();
                for(com.example.covid.coordinates i:distance_coordinatesList1)
                {
//                    Toast.makeText(track.this,"dist b/w "+u1.getLat()+"&"+i.getLat(),Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(com.example.covid.track.this,"dist b/w "+u1.getPhoneNo()+"&"+i.getPhoneNo()+" is"+dist,Toast.LENGTH_SHORT).show();

                    if(dist<=0.0018288)
                    {
                        Toast.makeText(com.example.covid.track.this,"dist b/w "+u1.getPhoneNo()+"&"+i.getPhoneNo()+" is very less",Toast.LENGTH_SHORT).show();
                ...
                if(interacted_people.size()!=0)
                {
                    if(user.getInteracted_user().size()!=0)
                    {
                        ...
                        Toast.makeText(com.example.covid.track.this, "user list " + interacted_people, Toast.LENGTH_SHORT).show();
                        com.example.covid.user user_in = new com.example.covid.user(user_phone_no,user.getInteracted_user());
                        Toast.makeText(com.example.covid.track.this, "user list " + user_in.getInteracted_user(), Toast.LENGTH_SHORT).show();
                        FirebaseDatabase.getInstance().getReference().child("User").child(userid).setValue(user_in);
                    }
                    else
                    {
                        Toast.makeText(com.example.covid.track.this, "user list empty", Toast.LENGTH_SHORT).show();
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(com.example.covid.track.this,
